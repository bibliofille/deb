 ...
 * 
 */
class deb_custom_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'This is a special custom widget', 'deb' ), ) // Args
		);
	}
...
add_action( 'widgets_init', 
	create_function( '', 'register_widget( "deb_custom_widget" );' ) 
); ?>